  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          property="og:title"
          content="Howdy Morning — Your daily food &amp; health loop"
        />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="675" />
        <meta
          property="og:description"
          content="The morning routine that checks you — log meals, scan barcodes, track your energy, and build habits that actually stick. howdymornin.io"
        />
        <meta
          property="og:image"
          content="https://howdymornin.io/og-image.jpg"
        />
